...
function DraggableSentence({ answer, isUsed }) {
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className={`p-2 bg-white border rounded shadow-sm cursor-grab text-sm ${
        isUsed
          ? "bg-gray-100 text-gray-400"
          : "text-blue-700 hover:border-blue-500"
      }`}
    >
      {answer.text}
    </div>
    ...
    <div className="main-container-component">
      <div className="div-forall" style={{ gap: "20px" }}>
        <h1 className="WB-header-title-page8">
          <span className="WB-ex-A">D</span>Look and complete the conversations.
        </h1>
        ...
        >
          ...
          <Button
            ...
            handleStartAgain={() => {
              setPlacedAnswers({ q1: null, q2: null, q3: null, q4: null });
