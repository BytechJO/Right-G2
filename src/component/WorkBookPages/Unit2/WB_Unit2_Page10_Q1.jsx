...
const WB_Unit2_Page10_Q1 = () => {
  ...
  const data = [
    { id: 1, img: img, options: ["This", "is a flower.","That"], correct: "This" },
    { id: 2, img: img, options: ["This", "is a clock.","That"], correct: "This" },
    { id: 3, img: img, options: ["Those", "are queens.","These"], correct: "These" },

    { id: 4, img: img, options: ["Those", "are trees.","These"], correct: "Those" },
    { id: 5, img: img, options: ["This", "is a dog.","That"], correct: "That" },
    { id: 6, img: img, options: ["That", "is a fox.","This"], correct: "That" },
  ];
