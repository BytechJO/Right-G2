...
const SentenceBuilder = ({ id, scrambled, correct, onUpdate, showResult, src, forceAnswer }) => {
    ...
    return (
        <div className="space-y-3">
            <div className="flex flex-wrap gap-2 p-3 bg-gray-100 rounded-lg min-h-[50px] items-center">
                <img src={src} className='max-w-16 max-h-16 object-contain' />
...
const WB_Unit2_Page13_Q1 = () => {
    ...
    const exerciseSentences = [
        { id: 's1', scrambled: 'small This rabbit is a', correct: 'This is a small rabbit.' },
        { id: 's2', scrambled: 'ducks These are', correct: 'These are ducks.' },
        { id: 's3', scrambled: 'sun That the is', correct: 'That is the sun.' },
        { id: 's4', scrambled: 'white Those clouds are', correct: 'Those are white clouds.' },
    ];
    ...
    const checkAnswers = () => {
        ...
        exerciseSentences.forEach(sentence => {
            // إزالة أي علامات ترقيم في آخر الجملة ومقارنة الكلمات فقط
    ...
    return (
        <div key={resetKey} className="p-6 max-w-3xl mx-auto font-sans">
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="header-title-page8">Look, unscramble, and write.</h1>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1">
                        <p className="text-lg text-gray-400 line-through">are horses Those black</p>
                        <p className="text-lg text-gray-900 font-semibold">Those are black horses.</p>
                    </div>
                </div>
