...
const QUESTIONS = [
  { key: "q1", personImg: imgJohn, itemImg: imgBike, prefix: "John" },
  { key: "q2", personImg: imgMomAunt, itemImg: imgDress, prefix: "Mom and my aunt" },
  { key: "q3", personImg: imgDad, itemImg: imgTie, prefix: "Dad" },
  { key: "q4", personImg: imgGrandpa, itemImg: imgGlasses, prefix: "Grandpa has" },
  { key: "q5", personImg: imgSarahJack, itemImg: imgDollRobot, prefix: "Sarah and Jack" },
  { key: "q6", personImg: imgHelenStella, itemImg: imgDresses, prefix: "Helen and Stella" },
];
...
const WB_Unit8_Page48_Q2 = () => {
  ...
  const availableChips = SHUFFLED_CHIPS;
  ...
  const onDropZoneChipDragStart = (e, chipId) => {
    draggingChip.current = chipId;
    e.dataTransfer.effectAllowed = "move";
  };
      ...
      <div className="div-forall" style={{ gap: "10px" }}>
        ...
        >
          {availableChips.map((chip) => {
            const isUsed = usedChips.has(chip.id);
            ...
            return (
              <span
                ...
                draggable={!isUsed}
                onDragStart={(e) => {
                  if (!isUsed) onChipDragStart(e, chip.id);
                }}
                style={{
                  ...getChipStyle(),
        ...
        <div className="flex gap-4">
          <div className="flex flex-col gap-2" style={{ minWidth: 64 }}>
            {QUESTIONS.map((q) => (
              <div key={q.key} className="flex items-center justify-center" style={{ height: 56 }}>
                <img src={q.personImg} style={{ maxWidth: 90, maxHeight: 90 }} />
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-2" style={{ minWidth: 64 }}>
            {QUESTIONS.map((q) => (
              <div key={q.key} className="flex items-center justify-center" style={{ height: 56 }}>
                <img src={q.itemImg} style={{ maxWidth: 90, maxHeight: 90 }} />
              </div>
            ))}
          </div>
            ...
            {QUESTIONS.map((q, idx) => {
              ...
              return (
                <div key={q.key} className="flex items-center gap-2" style={{ height: 56 }}>
                  ...
                  <div
                    style={{ borderBottom: "2px dashed #3b82f6", minWidth: 150 }}
                  ...
                  >
                    {droppedChip ? (
                      <span
                        draggable
                        onDragStart={(e) =>
                          onDropZoneChipDragStart(e, droppedChip.id)
                        }
                      >
                        {droppedChip.label}
                      </span>
                    ) : (
                      <span style={{ color: "#ccc" }}>Drop here...</span>
                    )}
                  </div>
                </div>
              );
