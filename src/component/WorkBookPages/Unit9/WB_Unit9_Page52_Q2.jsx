...
const exerciseData = [
    { id: 1, name: "Tom", before: "", after: "home.", correct: "is walking", image: img1 },
    { id: 2, name: "Stella", before: "", after: ".", correct: "is sleeping", image: img2 },
    { id: 3, name: "The cat", before: "", after: ".", correct: "is climbing", image: img3 },
    { id: 4, name: "Mom", before: "", after: "TV.", correct: "is watching", image: img4 },
    { id: 5, name: "John", before: "", after: ".", correct: "is running", image: img5 },
    { id: 6, name: "Dad", before: "", after: "with my uncle.", correct: "is playing", image: img6 },
];
            ...
            <div className="mb-12 border-2 border-gray-800 rounded-xl overflow-hidden shadow-sm">
                <div className="grid grid-cols-3 divide-x-2 divide-gray-800">
                    <div className="p-4 flex flex-col gap-2">
                        <div className="flex justify-between text-xl font-medium"><span>watch</span> <span>-</span> <span className="text-blue-700">watching</span></div>
                        <div className="flex justify-between text-xl font-medium"><span>play</span> <span>-</span> <span className="text-blue-700">playing</span></div>
                    </div>
                    <div className="p-4 flex flex-col gap-2">
                        <div className="flex justify-between text-xl font-medium"><span>climb</span> <span>-</span> <span className="text-blue-700">climbing</span></div>
                        <div className="flex justify-between text-xl font-medium"><span>run</span> <span>-</span> <span className="text-blue-700">running</span></div>
                    </div>
                    <div className="p-4 flex flex-col gap-2">
                        <div className="flex justify-between text-xl font-medium"><span>walk</span> <span>-</span> <span className="text-blue-700">walking</span></div>
                        <div className="flex justify-between text-xl font-medium"><span>sleep</span> <span>-</span> <span className="text-blue-700">sleeping</span></div>
                    </div>
                </div>
            </div>
