...
const SentenceBuilder = ({ id, scrambled, correct, onUpdate, showResult, src, forceAnswer }) => {
    ...
    <img 
        src={src} 
        className="ml-auto max-w-16 max-h-16 object-contain"
    />
</div>
...
const WB_Unit5_Page30_Q1 = () => {
    ...
    const exerciseSentences = [
        ...
        { id: 's2', scrambled: 'He doesn’t like chicken.', correct: 'He doesn\'t like meat.' },
    ...
    return (
        <div key={resetKey} className="p-6 max-w-3xl mx-auto font-sans">
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="header-title-page8">Look, read, and write ✕ over the mistake. Rewrite the sentence.</h1>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1">
                        <p className="text-lg text-gray-400 line-through">She doesn’t like rice.</p>
                        <p className="text-lg text-gray-900 font-semibold">she doesn't like fruit.</p>
                    </div>
