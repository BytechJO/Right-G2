      ...
      <div className="flex flex-wrap gap-2 p-3 bg-gray-100 rounded-lg min-h-[50px] items-center">
        {availableWords.map((word) => (
          <button
            ...
            className="px-3 py-1 bg-white border border-gray-400 rounded-md shadow-sm hover:bg-blue-100"
          >
            {word.text}
          </button>
        ))}
        <img src={src} className="ml-auto max-w-16 max-h-16" />
      </div>

     <div className="relative">
  <div className="flex flex-wrap gap-2 p-3 border-2 rounded-lg min-h-[60px]">
    ...
    <div className="main-container-component">
      <div className="div-forall" style={{ gap: "20px", marginBottom: "50px" }}>
        <h1 className="WB-header-title-page8">
          <span className="WB-ex-A">G</span> Look, read, and write <span style={{color:"navy"}}>✕</span> over the
          mistake. Rewrite the sentence.
        </h1>
