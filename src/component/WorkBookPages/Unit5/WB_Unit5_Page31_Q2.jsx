...
const WB_Unit5_Page31_Q2 = () => {
    ...
    const exerciseSentences = [
        { id: 's1', scrambled: 'ice . wants She cream', correct: 'she wants ice cream' },
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1">
                        <p className="text-lg text-gray-400 line-through">an He apple . wants</p>
                        <p className="text-lg text-gray-900 font-semibold">He wants an apple.</p>
                    </div>
                </div>
