...
const SentenceBuilder = ({
  ...
  return (
    <div className="space-y-3">
      ...
      {/* صندوق الإجابة مع الإكس */}
      <div className="relative">
        <div
          className={`flex flex-wrap gap-2 p-3 border-2 rounded-lg min-h-[60px] transition-colors duration-300 items-center pr-12 ${getBoxClassName()}`}
        >
