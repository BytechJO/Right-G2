...
const gridLetters = [
  ..."xthexysbirdsxerflyqnmizop",
  ..."inmkilopxeftheickmkmkloab",
  ..."fndssbvrwskyc sj".replace(/\s/g, ""),
];

  const correctAnswer = "the birds fly in the sky";
            ...
            <DragDropContext onDragEnd={onDragEnd}>
              ...
              <div className="img-input-container">
                ...
                <div className="input-wrapper">
                  {isWrong && <div className="wrong-icon">✕</div>}
