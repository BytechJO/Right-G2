...
import allUnitSound from "../../../assets/audio/ClassBook/U 1/unit1 all.mp3";
...
const Page4 = ({ openPopup }) => {
  ...
  const captionsExample = [
    { start: 0.44, end: 4.02, text: "Page 4, Unit 1. Stella's Family." },
    { start: 5.04, end: 7.75, text: "Page 4. Listen and read along." },
    { start: 9.02, end: 12.4, text: "L. Lamb. Leg. Lemon." },
    {
      start: 13.54,
      end: 25.52,
      text: "Page 4, Unit 1, vocabulary. 1. Father. 2. Knock. 3. Brother.",
    },
    { start: 26.6, end: 28.42, text: "4. Mother." },
    { start: 29.54, end: 34.27, text: "5. Sister. 6. Play." },
    { start: 35.32, end: 40.12, text: "7. Cousin. 8. Aunt." },
    { start: 41.22, end: 43.14, text: "9. Uncle." },
    { start: 44.2, end: 47.23, text: "Page 5. Meet my family." },
    {
      start: 48.36,
      end: 66.6,
    ...
    { start: 67.62, end: 70.79, text: "Page 5. Listen and read along." },
    { start: 72.14, end: 77.29, text: "R. Rabbit. Run. Red." },
  ];
