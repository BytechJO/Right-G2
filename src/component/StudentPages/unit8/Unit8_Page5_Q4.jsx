...
const Unit8_Page5_Q4 = () => {
  ...
  const correctPositions = {
    ...
    starts: [100 + 17, 100 + 18, 100 + 19, 100 + 20, 100 + 21],
    in: [100 + 25, 100 + 26],
    june: [200 + 2, 200 + 3, 200 + 4, 200 + 5],
  };
    ...
    >
      <div className="div-forall">
        <h5 className="header-title-page8 pb-2.5">
          ...
          When does summer vacation start? Tap or click the hidden words to make
          a sentence.
        </h5>
