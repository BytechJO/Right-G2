...
const Review1_Page1_Q1 = () => {
  ...
  const items = [
    ...
    { img: img4, options: ["grandpa", "father"], correctIndex: 0 },
    { img: img2, options: ["mother", "brother"], correctIndex: 0 },
    { img: img5, options: ["brother", "sister"], correctIndex: 0 },
    { img: img3, options: ["grandpa", "grandma"], correctIndex: 1 },
